...
export const ScenePhilosophy: React.FC = () => {
  return (
    <section id="philosophy" className="py-20 sm:py-36 bg-ym-subtle/30 text-ym-body relative border-t border-ym overflow-hidden transition-colors duration-300">
      ...
      <span className="absolute top-4 sm:top-0 left-1/2 -translate-x-1/2 text-[2rem] sm:text-9xl lg:text-[10rem] font-black text-[#4BA0A4] opacity-[0.04] dark:opacity-[0.07] pointer-events-none select-none font-mono tracking-tighter uppercase whitespace-nowrap z-0">
        PHILOSOPHY
      </span>
