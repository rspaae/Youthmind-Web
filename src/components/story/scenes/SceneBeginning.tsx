...
export const SceneBeginning: React.FC = () => {
  return (
    <section id="beginning" className="py-20 sm:py-36 bg-ym-page text-ym-body relative border-t border-ym overflow-hidden transition-colors duration-300">
      ...
      <Container size="small">
        <div className="space-y-6 sm:space-y-8 text-center px-2">
          ...
          <RevealText
            ...
            className="text-xl sm:text-4xl md:text-5xl font-extrabold text-ym-heading justify-center leading-snug sm:leading-relaxed"
          />

          <p className="text-xs sm:text-base text-ym-body max-w-xl mx-auto leading-relaxed pt-2 font-normal">
