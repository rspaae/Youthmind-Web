...
export const SceneFinal: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-24 sm:py-36 bg-[#091F21] text-white relative border-t border-[#4BA0A4]/25 overflow-hidden">
      ...
      <Container size="medium">
        <div className="space-y-16 max-w-6xl mx-auto relative z-10">
          ...
          <div className="text-center space-y-4 max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#4BA0A4]/20 border border-[#4BA0A4]/35 text-[#59AAAA] text-[11px] sm:text-xs font-black uppercase tracking-widest">
            ...
            <p className="text-xs sm:text-base text-[#94D4D4] max-w-2xl mx-auto leading-relaxed font-medium">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="bg-gradient-to-b from-[#133A3D] to-[#0E2A2C] border border-[#4BA0A4]/35 rounded-3xl p-6 sm:p-8 space-y-6 shadow-xl relative overflow-hidden group">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-[10px] font-black uppercase tracking-wider text-[#59AAAA]">Markas Utama</span>
                    <h3 className="text-lg font-black text-white">SMKN 11 Bandung</h3>
                  </div>
                </div>

                <div className="space-y-2 text-xs sm:text-sm text-[#E0F4F4] leading-relaxed border-t border-[#4BA0A4]/20 pt-4">
                  <p className="font-semibold text-white">YouthMind Student Company Secretariat</p>
                  <p className="text-[#94D4D4]">
                    Jl. Budhi, Cilember, Kec. Cicendo, Kota Bandung, Jawa Barat 40175, Indonesia
                  </p>
                </div>

                <div className="flex items-center gap-2 text-[11px] font-bold text-[#59AAAA] pt-1">
              ...
              <div className="bg-gradient-to-b from-[#133A3D] to-[#0E2A2C] border border-[#4BA0A4]/35 rounded-3xl p-6 sm:p-8 space-y-6 shadow-xl relative overflow-hidden">
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <span className="text-[10px] font-black uppercase tracking-wider text-[#59AAAA]">Surel Resmi</span>
                      <h3 className="text-lg font-black text-white">Surat & Kemitraan</h3>
                    </div>
                  </div>

                  <a
                    href="mailto:youthmindcompany@gmail.com"
                    className="block p-4 rounded-2xl bg-[#0E2A2C] border border-[#4BA0A4]/30 hover:border-[#4BA0A4] transition-all group"
                  >
                    <span className="text-xs text-[#94D4D4] block mb-0.5">Email Resmi Perusahaan:</span>
                    <span className="text-sm sm:text-base font-extrabold text-white group-hover:text-[#59AAAA] transition-colors flex items-center justify-between">
                ...
                <div className="pt-4 border-t border-[#4BA0A4]/20 space-y-2">
                  <div className="flex items-center gap-2 text-[11px] font-extrabold text-[#59AAAA] uppercase tracking-wider">
                    <ShieldCheck className="w-4 h-4 text-[#4BA0A4]" />
                    <span>Dukungan Program Resmi</span>
                  </div>
                  <p className="text-xs text-[#94D4D4] leading-relaxed">
                    Didukung oleh <strong className="text-white">Prestasi Junior Indonesia</strong> & <strong className="text-white">Zurich Indonesia</strong> (JA Student Company Program).
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7">
              <div className="bg-gradient-to-b from-[#163E41] via-[#123638] to-[#0E2A2C] border border-[#4BA0A4]/40 rounded-3xl p-6 sm:p-10 shadow-2xl relative overflow-hidden">
                <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#4BA0A4] to-transparent opacity-80" />

                <div className="space-y-6">
                  <div>
                    <span className="text-[11px] font-black uppercase tracking-widest text-[#59AAAA] bg-[#4BA0A4]/20 px-3 py-1 rounded-full border border-[#4BA0A4]/30 inline-block mb-3">
                      Formulir Kemitraan & Informasi
                    </span>
                    <h3 className="text-xl sm:text-3xl font-black text-white">
                      Kirim Pesan atau Pengajuan Kemitraan
                    </h3>
                    <p className="text-xs sm:text-sm text-[#94D4D4] font-medium pt-1">
                  ...
                  <AnimatePresence mode="wait">
                    {formSubmitted ? (
                      <motion.div
                        ...
                        className="p-8 rounded-2xl bg-[#0E2A2C] border border-[#4BA0A4] text-center space-y-4 my-8"
                      >
                        ...
                        <p className="text-xs sm:text-sm text-[#94D4D4] max-w-md mx-auto leading-relaxed">
                      ...
                      <form onSubmit={handleSubmit} className="space-y-4 pt-2">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <div className="space-y-1.5">
                            ...
                            <input
                              ...
                              className="w-full px-4 py-3 rounded-xl bg-[#0E2A2C] border border-[#4BA0A4]/35 text-white text-xs sm:text-sm focus:outline-none focus:border-[#4BA0A4] focus:ring-1 focus:ring-[#4BA0A4] transition-all placeholder-[#59AAAA]/50"
                            />
                          </div>
                        ...
                        <div className="space-y-1.5">
                          ...
                          <textarea
                            ...
                            className="w-full px-4 py-3 rounded-xl bg-[#0E2A2C] border border-[#4BA0A4]/35 text-white text-xs sm:text-sm focus:outline-none focus:border-[#4BA0A4] focus:ring-1 focus:ring-[#4BA0A4] transition-all placeholder-[#59AAAA]/50 leading-relaxed"
                          />
                        </div>
