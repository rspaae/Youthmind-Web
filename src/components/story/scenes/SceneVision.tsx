...
export const SceneVision: React.FC = () => {
  return (
    <section
      id="vision"
      className="py-24 sm:py-36 bg-ym-page text-ym-body relative border-t border-ym overflow-hidden transition-colors duration-300"
    >
      ...
      <Container>
        ...
        >
          ...
          <div className="relative bg-ym-card border border-ym rounded-3xl p-8 sm:p-14 lg:p-16 shadow-2xl overflow-hidden group transition-colors duration-300">
            {/* Top Glowing Edge */}
            ...
            <span className="absolute -top-4 sm:-top-6 right-4 sm:right-8 text-5xl sm:text-9xl font-black text-[#4BA0A4] opacity-[0.04] dark:opacity-[0.07] pointer-events-none select-none font-mono tracking-tighter">
              VISION
            </span>
            ...
            <div className="relative z-10 space-y-8 text-center max-w-4xl mx-auto">
              ...
              <div className="space-y-4">
                <p className="text-2xl sm:text-4xl lg:text-5xl font-black text-ym-heading leading-tight tracking-tight">
                  "Menjadi pelopor permainan edukatif yang menginspirasi{" "}
                  <span className="text-teal-700 dark:text-teal-300">kebahagiaan, ketenangan,</span>{" "}
                  dan kesadaran{" "}
              ...
              {/* Description Detail */}
              <p className="text-xs sm:text-base text-ym-muted font-medium leading-relaxed max-w-2xl mx-auto pt-2">
